...
stargazer(plotting_data[, 3:(ncol(plotting_data)-1)], type='latex', median=TRUE, nobs=FALSE, omit.summary.stat = c("p25", "p75"))
#take keysar out
...
correlationmatrix <- cor(data1[,c("director_alt","director_ego", "dot_alt_rt","dot_ego_rt","dot_alt_err")])
...
#fluid int breaks this, possibly because of negative values
#stargazer(fullcorrelationmatrix, title="Table 1")
